...
if (idade >= 18) { console.log('Que legal! Você já pode ter a carteira de habilitação')}
else {console.log('Poxa, que pena! Você ainda não pode ter a carteira de habilitação.')}
...
let terminouEnsMedio = true;

if (terminouEnsMedio === true) {
